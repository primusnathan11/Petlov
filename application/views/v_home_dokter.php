		...
		<header class="header_section">
			<div class="container">
				<nav class="navbar navbar-expand-lg custom_nav-container ">
					<a class="navbar-brand" href="<?php echo base_url('Home/home_dokter')?>">
						<span>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav">
							<li class="nav-item active">
								<a class="nav-link" href="<?php echo base_url('Home/home_dokter')?>">Beranda</span></a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="https://wa.me/<?php echo $this->session->userdata('telp_dokter')?>" target="_blank" > Chat </a>
							</li>
							...
							<div class="row">
								<div class="col-md-7">
									<div class="detail-box">
										...
										<div class="btn-box">
											<a href="https://wa.me/<?php echo $this->session->userdata('telp_dokter')?>" target="_blank" class="btn1">
												Cek Konsultasi
											</a>
										</div>
									</div>
