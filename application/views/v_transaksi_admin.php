	...
	<table class="table table-hover" id="transaksi_admin" style="width:100%;">
        ...
        <?php $no=1; ?>
				...
				<tr>
                    ...
                    <td>
                    <a href="<?php echo base_url('uploads/bukti_transfer/'.$isi->foto_bukti);?>">
                    <img src="<?php echo base_url('uploads/bukti_transfer/'.$isi->foto_bukti);?>" style="width:100px; height:100px" alt="">
                    </a>
					</td>
                    <td>
