...
<body class="sub_page">
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<li class="nav-item active">
								<a class="nav-link" href="<?php echo base_url('Home/home_petshop')?>">Home <span class="sr-only">(current)</span></a>
							</li>
							<li class="nav-item">
  ...
  <!-- cart section -->
	...
	<section class="cart">
	<table class="table table-hover" id="PesananPenjual" style="width:100%;">
			    <thead>
					<tr> 
                        <th>No</th>
						<th>ID Transaksi</th>
        ...
        <?php $no=1; ?>
				...
				<tr>
                    ...
                    <td>
                    <?php if($isi->status=="Pesanan Diproses"){?>
                        <a href="#modal_resi" onclick="tm_detail('<?php echo ($isi->id_transaksi)?>')" data-toggle="modal" class="btn btn-warning">
					...
					<td>
            <a href="<?php echo base_url().'Shop/lihat_detail/'.$isi->id_transaksi?>">Lihat Detail</a>
          </td>
				</tr>
				<?php endforeach; ?>
			</tbody>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('Shop/status_dikirim')?>" method="post">
        
        <input type="name" id="id_transaksi" name="id_transaksi"> <br>
