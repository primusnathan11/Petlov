			...
			<div class="container ">
				...
				<div class="row">
					<div class="col-md-3">
						<div class="box ">
							<div class="img-box">
								<img src="<?php echo base_url()?>assets/images/s1.png" alt="">
							</div>
							<div class="detail-box">
								<h5>
									Cardiology
					...
					<div class="col-md-3">
						<div class="box ">
							<div class="img-box">
								<img src="<?php echo base_url()?>assets/images/s2.png" alt="">
							</div>
							<div class="detail-box">
								<h5>
									Diagnosis
					...
					<div class="col-md-3">
						<div class="box ">
							<div class="img-box">
								<img src="<?php echo base_url()?>assets/images/s3.png" alt="">
							</div>
							<div class="detail-box">
								<h5>
									Surgery
					...
					<div class="col-md-3">
						<div class="box ">
							<div class="img-box">
								<img src="<?php echo base_url()?>assets/images/s4.png" alt="">
							</div>
							<div class="detail-box">
								<h5>
									First Aid
					...
					<div class="carousel-item active">
						<div class="row">
							<div class="col-md-11 col-lg-10 mx-auto">
								<div class="box">
									<div class="img-box">
										<img src="<?php echo base_url()?>assets/images/client.jpg" alt="" />
									</div>
									<div class="detail-box">
										<div class="name">
											<h6>
