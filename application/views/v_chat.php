...
<body class="sub_page">
  ...
  <!-- cart section -->
	...
	<section class="cart">
		<h1>Dokter-dokter Petlov</h1>
		<div class="row" style="margin-top:20px;">
			<?php foreach($data_dokter as $isi):?>
			<div class="col-lg-4 col-md-6">
			<div class="card" style="width: 18rem;">
				<div class="card-body">
					<h5 class="card-title"><?php echo $isi->nama_dokter ?></h5>
					<h6 class="card-subtitle mb-2 text-muted">+<?php echo $isi->telp_dokter ?></h6>
					<p class="card-text"><?php echo $isi->alamat_dokter ?></p>
					<a href="https://wa.me/<?php echo $isi->telp_dokter?>" class="card-link" target="_blank"><i class="fab fa-whatsapp"></i></a>
				</div>
			</div>
			</div>
				<?php endforeach; ?>
