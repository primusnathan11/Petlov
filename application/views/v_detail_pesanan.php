...
<body class="sub_page">
  ...
  <!-- cart section -->
	...
	<section class="cart">
		<h3>Detail Transaksi <?php echo $id_trans?> </h3>
        ...
        <?php $no=1; ?>
                ...
                foreach ($detail as $isi) : ?>
                  <tr>
                    ...
                    <td>
                    <img src="<?php echo base_url('uploads/products/'.$isi->gambar_produk);?>" alt="..." style="width:100px;height:100px">
                    ...
                    <td>
										<?php echo "Rp. ".number_format($isi->harga)?>
                    </td>
				</tr>
		<?php endforeach; ?>
		</tbody>
